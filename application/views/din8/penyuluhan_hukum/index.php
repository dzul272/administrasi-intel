<div class="page-wrapper">
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-12">
                <h4 class="page-title">Data Foto Dokumentasi Penyuluhan Hukum</h4>
            </div>
        </div>
    </div>
                    ...
                    <form action="" method="get">
                        <div class="card-body">
                            ...
                            <div class="float-right">
                                ...
                                ?>
                                <a target="_blank" href="<?= base_url('din8/penyuluhan-hukum-export/?tahun=' . $this->input->get("tahun")) ?>" id="export" type="button" class="btn waves-effect waves-light btn-danger" style="width: 120px;">Export</a>
                            </div>
                        </div>
                    </form>
                </div>
        ...
        <div class="modal fade myModal" id="tambahData" role="dialog">
            <div class="modal-dialog modal-md" role="document">
                <div class="modal-content">
                    ...
                    <form id="form-insert" method="POST" action="<?= base_url("din8/addPenyuluhanHukum") ?>" enctype='multipart/form-data'>
                        <div class="modal-body">
                            <div class="form-group">
                                <label for="recipient-name" class="control-label">Kegiatan Penyuluhan Hukum <span class="text-danger">*</span></label>
        ...
        <div class="modal fade myModal" id="modal_ubah" role="dialog">
            <div class="modal-dialog modal-md" role="document">
                <div class="modal-content">
                    ...
                    <form id="form-edit" method="POST" action="<?= base_url("din8/updatePenyuluhanHukum") ?>" enctype='multipart/form-data'>
                        <div class="modal-body">
                            <div class="form-group">
                                <label for="recipient-name" class="control-label">Kegiatan Penyuluhan Hukum <span class="text-danger">*</span></label>
...
<script>
    ...
    var table_data = $('#table_data').DataTable({
        "ajax": {
            "url": "<?= base_url('din8/getDataPenyuluhanHukum/' . $this->input->get("tahun")) ?>",
            "dataSrc": "data",
        },
        "order": [
            [0, "asc"]
    ...
    $("#form-insert").on('submit', (function(event) {
        ...
        $.ajax({
            url: "<?= base_url('din8/addPenyuluhanHukum') ?>",
            type: "POST",
    ...
    $("#form-edit").on('submit', (function(event) {
        ...
        $.ajax({
            url: "<?= base_url('din8/updatePenyuluhanHukum') ?>",
            type: "POST",
            data: new FormData(this),
            dataType: "JSON",
            contentType: false,
    ...
    function edit(id) {
        Swal.fire({
            ...
            onBeforeOpen: () => {
                ...
                $.ajax({
                    type: 'GET',
                    url: '<?= base_url('din8/getDataPenyuluhanHukum/') ?>',
                    dataType: "json",
                    data: {
                        "id": id
                    },
            ...
            if (result.value) {
                ...
                Swal.fire({
                    ...
                    onBeforeOpen: () => {
                        ...
                        $.ajax({
                            type: "POST",
                            url: "<?= base_url('din8/deletePenyuluhanHukum') ?>",
                            data: {
                                "id_data": id
                            },
                            dataType: "json",
