<form id="form-headline-artikel" action="<?= base_url("website/update_headline_artikel") ?>" enctype="multipart/form-data" method="post">
    <div class="col-md-12 mb-4">
        <img style="width: 100%" id="imgPreview" src="<?= isset($headlineArtikel->gambar_headline) ? asset_file_desa($headlineArtikel->gambar_headline) : asset("website/img/1920x300.jpg") ?>" alt="">
    </div>
    <div class="row col-md-12 mr-0 pr-0">
        <div class="input-group">
            <label for="fname" class="row col-md-12 control-label col-form-label">Foto Headline Artikel <span class="text-danger"> *</span></label>
            ...
            <div class="custom-file">
                ...
                <label class="custom-file-label" for="inputGroupFile"><?= "Pilih File Foto Headline Artikel" ?></label>
            </div>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <a href="#" data-id='<?= set($headlineArtikel->id_headline) ?>' id="btnReset" type="button" class="btn pull-right btn-danger text-white ml-2 ultra-disabled">Reset Default</a>
...
<script>
    ...
    $("#btnReset").click(function(event) {
        ...
        Swal.fire({
            ...
            text: "Headline Artikel akan di reset ke setelan awal !",
            type: 'warning',
    ...
    $("#form-headline-artikel").on('submit', (function(event) {
        event.preventDefault();
        $("#add-btn").html("Sedang Menyimpan...");
        $("#add-btn").attr("disabled", true);
        $.ajax({
            url: "<?= base_url('website/update_headline_artikel') ?>",
            type: "POST",
