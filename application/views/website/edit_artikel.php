<div class="page-wrapper">
    ...
    <div class="container-fluid">
        <form id="form-edit-artikel" enctype="multipart/form-data" method="post">
            <div class="row">
                <div class="row col-md-12">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input required value="<?= $artikel->judul_artikel ?>" type="text" class="form-control" name="judul_artikel" id="judul_artikel " required>
                                        </div>
                                        <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="m-b-10">
                                    <img style="width: 100%" id="imgPreview" src='<?= !empty($artikel->headline_artikel) ? asset_file_desa($artikel->headline_artikel) : asset("website/img/ukuran-banner.jpg") ?>' alt="">
                                </div>
                                <div class="input-group">
                                    <button type="button" class="btn btn-info"><i class="ti-import text-white"></i></button>
                                    <div class="custom-file">
                                        <input <?= empty($artikel->headline_artikel) ? "required" : "" ?> accept="image/*" type="file" class="custom-file-input" id="file_gambar_headline" name="file_gambar_headline">
                                        <label class="custom-file-label" for="inputGroupFile"><?= !empty($artikel->headline_artikel) ? $artikel->headline_artikel : "Pilih File Gambar Headline" ?></label>
                                    </div>
                            ...
                            <div class="card-body">
                                <select required class="select2 form-control custom-select" style="width: 100%;" name="id_kategori" id="id_kategori">
                                    ...
                                    <?php foreach ($kategori_artikel as $kategori) : ?>
                                        <option <?= $artikel->id_kategori == $kategori->id_kategori ? "selected" : "" ?> value='<?= $kategori->id_kategori ?>'><?= $kategori->nama_kategori ?></option>
                                    <?php endforeach ?>
                                </select>
                            </div>
                            ...
                            <div class="card-body">
                                <div class="input-group">
                                    ...
                                    <div class="custom-file">
                                        ...
                                        <label class="custom-file-label" for="inputGroupFile"><?= !empty($artikel->lampiran_artikel) ? $artikel->lampiran_artikel : "Pilih Dokumen Lampiran" ?></label>
                                    </div>
                                    <div class="col-12 p-r-0 p-l-0">
                                ...
                                <div class="form-group mb-0 mt-2">
                                    ...
                                    <input value='<?= $artikel->namalampiran_artikel ?>' type="text" class="form-control" name="nama_dokumen" id="nama_dokumen">
...
<script>
    ...
    $("#form-edit-artikel").submit(function(event) {
        event.preventDefault();
        $("#add-btn").html("Sedang Menyimpan...");
        $("#add-btn").attr("disabled", true);
        Swal.fire({
            title: 'Mohon Tunggu Beberapa Saat',
            text: 'Proses Mengubah Artikel...',
            onBeforeOpen: () => {
                Swal.showLoading();
                $.ajax({
                    url: "<?= base_url('website/proses_ubah_artikel') ?>",
                    type: "POST",
