<div class="page-wrapper">
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-12">
                <h4 class="page-title">D.IN.7 - Data Jaksa Masuk Sekolah</h4>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="float-right">
                            ...
                            <!-- <a target="_blank" href="<?= base_url('din7/jaksa-masuk-sekolah/export') ?>" id="export" type="button" class="btn waves-effect waves-light btn-danger" style="width: 120px;">Export</a> -->
        ...
        <div class="modal fade myModal" id="tambahData" role="dialog">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <form id="form-insert" method="POST" action="<?= base_url("din7/addJaksaMasukSekolah") ?>" enctype='multipart/form-data'>
                        <div class="modal-body">
                            <label for="recipient-name" class="control-label text-info">Pelaksanaan Program Jaksa Masuk Sekolah (JMS) Secara Langsung</label>
                            <div class="form-group">
                                <label for="recipient-name" class="control-label">Sasaran Peserta Program JMS<span class="text-danger">*</span></label>
                            ...
                            <label for="recipient-name" class="control-label text-info">Pelaksanaan Program Jaksa Masuk Sekolah (JMS) Secara Tidak Langsung</label>
                            <div class="form-group">
        ...
        <div class="modal fade myModal" id="modal_ubah" role="dialog">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <form id="form-edit" method="POST" action="<?= base_url("din7/updateJaksaMasukSekolah") ?>" enctype='multipart/form-data'>
                        <div class="modal-body">
                            <label for="recipient-name" class="control-label text-info">Pelaksanaan Program Jaksa Masuk Sekolah (JMS) Secara Langsung</label>
                            <div class="form-group">
                                <label for="recipient-name" class="control-label">Sasaran Peserta Program JMS <span class="text-danger">*</span></label>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">                        
                        <div class="form-group">
                            ...
                            <form action="<?= base_url("din7/jaksa-masuk-sekolah-export-sederhana") ?>" method="get" target="_blank">
                                <div class="row">
                                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <form action="<?= base_url("din7/jaksa-masuk-sekolah-export-lengkap") ?>" method="get" target="_blank">
                                <div class="row">
                                    <div class="col-md-6">
                                        <select class="select2 form-control custom-select" style="width: 100%;" name="tahun" required>
                                            <option value="">Pilih Tahun</option>
                        ...
                        <div class="table-responsive">
                            <table id="table_data" class="table table-striped table-bordered display">
                                <thead>
                                    ...
                                    <tr>
                                        <th style="padding: 10px; width: 200px" class="align-middle text-center">Sasaran Peserta Program JMS</th>
...
<script>
    ...
    var table_data = $('#table_data').DataTable({
        "ajax": {
            "url": "<?= base_url('din7/getDataJaksaMasukSekolah/' . $this->input->get("tahun") . "/" . $this->input->get("triwulan")) ?>",
            "dataSrc": "data",
        },
        "order": [
            [0, "asc"]
    ...
    $("#form-insert").on('submit', (function(event) {
        ...
        $.ajax({
            url: "<?= base_url('din7/addJaksaMasukSekolah') ?>",
            type: "POST",
    ...
    $("#form-edit").on('submit', (function(event) {
        ...
        $.ajax({
            url: "<?= base_url('din7/updateJaksaMasukSekolah') ?>",
            type: "POST",
            data: new FormData(this),
            dataType: "JSON",
            contentType: false,
    ...
    function edit(id) {
        Swal.fire({
            ...
            onBeforeOpen: () => {
                ...
                $.ajax({
                    type: 'GET',
                    url: '<?= base_url('din7/getDataJaksaMasukSekolah/') ?>',
                    dataType: "json",
                    data: {
                        "id": id
                    },
            ...
            if (result.value) {
                ...
                Swal.fire({
                    ...
                    onBeforeOpen: () => {
                        ...
                        $.ajax({
                            type: "POST",
                            url: "<?= base_url('din7/deleteJaksaMasukSekolah') ?>",
                            data: {
                                "id_data": id
                            },
                            dataType: "json",
