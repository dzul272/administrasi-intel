...
<div class="page-wrapper">
    ...
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-12">
                <h4 class="page-title">Cetak Surat Keterangan Domisili</h4>
            </div>
            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-header bg-secondary">
                        <h4 class="mb-0 text-white">Form Surat Keterangan Domisili</h4>
                    </div>
                    <div class="card-body">
                          <form action="<?= $form_action ?>" method="POST">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-9">
                                    <textarea class="form-control" rows="3" name="DOMISILIKET" id="keperluan"></textarea>
                                </div>
                            </div>
