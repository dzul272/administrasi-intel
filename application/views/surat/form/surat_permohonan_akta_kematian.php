...
<div class="page-wrapper">
    ...
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-12">
                <h4 class="page-title">Cetak Surat Permohonan Akta Kematian</h4>
            </div>
            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-header bg-secondary">
                        <h4 class="mb-0 text-white">Form Surat Permohonan Akta Kematian</h4>
                    </div>
                    <div class="card-body">
                        <form action="<?= $form_action ?>" method="POST">
                            ...
                            <div class="row" id="data_anak">
                                <div class="col-lg-12">
                                    ...
                                    <div class="form-group row">
                                        <div class="card-header bg-danger col-12">
                                            <h6 class="mb-0 text-white">Data Anak / Jenazah</h6>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="example-text-input" class="col-3 col-form-label">NIK</label>
                                    ...
                                    <div class="form-group row">
                                        <label for="example-search-input" class="col-3 col-form-label">Tempat / Tgl Lahir</label>
                                        <div class="col-9">
                                            <div class="row">
                                                <div class="col-md-8">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="input-group" style="width: 100%;">
                                                        <input type="text" class="form-control tgl_kelahiran_anak" id="datepicker-autoclose8" name="tgl_kelahiran_anak" placeholder="mm/dd/yyyy" required disabled>
                                                        <div class="input-group-append">
                                                            <span class="input-group-text"><i class="far fa-calendar-alt"></i></span>
                                                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-9">
                                            <div class="row">
                                                <div class="col-md-8">
                                                    <input class="form-control" type="text" value="" name="pekerjaan_anak" id="pekerjaan_anak" readonly placeholder="Pekerjaan">
                                                </div>
                                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" type="hidden" name="usia_anak" id="usia_anak" readonly>
                                    <div class="form-group row">
                                        <label for="example-search-input" class="col-3 col-form-label">Hari Kematian / Jam Kematian</label>
                                        <div class="col-9">
                                            <div class="row">
                                                <div class="col-md-8">
                                                    <input class="form-control" type="text" value="" name="hari_kematian" id="hari" placeholder="Hari Kematian" readonly required>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="input-group" style="width: 100%;">
                                                        <input type="time" class="form-control jam_mati_anak" id="jam_mati_anak" name="jam_mati_anak" placeholder="Jam Kematian" required>
                                                        <div class="input-group-append">
                                    ...
                                    <div class="form-group row">
                                        <label for="example-search-input" class="col-3 col-form-label">Sebab Kematian</label>
                                        <div class="col-9">
                                            <select class="select2 form-control custom-select" style="width: 100%;" name="sebab_kematian" id="sebab_kematian" required>
                                                <option value="">Pilih Sebab Kematian</option>
                                                <?php foreach (sebab_kematian() as $sebab) : ?>
                                    ...
                                    <div class="form-group row">
                                        <label for="example-search-input" class="col-3 col-form-label">Yang Menerangkan</label>
                                        <div class="col-9">
                                            <select class="select2 form-control custom-select" style="width: 100%;" name="yang_menerangkan" id="yang_menerangkan" required>
                                                <option value="">Pilih Salah Satu</option>
                                                <?php foreach (yang_menerangkan() as $penerang) : ?>
                                                    <option value="<?= $penerang ?>"><?= $penerang; ?></option>
                                                <?php endforeach; ?>
                                            </select>
                                        </div>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <h4 class="card-title"><b>Kelengkapan Persyaratan :</b></h4>
                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td style="padding: 5px;">Surat Keterangan Ahli Waris</td>
                                                    <td style="padding: 5px;">
                                                        <a href="<?= base_url('surat/cetak/surat_keterangan_ahli_waris') ?>" class="btn btn-sm btn-info waves-effect waves-light" target="_blank" type="button">
    ...
    <script>
        ...
        function manual2() {
            ...
            $("#pekerjaan_anak").attr("readonly", false);
        ...
        window.onload = function() {
            ...
            $(".tgl_kematian_anak").change(function() {
                let tgllahir = document.getElementById("datepicker-autoclose8").value;
                let tglmati = this.value;
                let dob = new Date(tgllahir);
                let today = new Date(tglmati);
                let age = Math.floor((today - dob) / (365.25 * 24 * 60 * 60 * 1000));
                $("#usia_anak").val(age);
                // document.getElementById('usia_anak').value = age.toFixed(1);
            });
                        ...
                        $.ajax({
                            ...
                            success: function(response) { // Ketika proses pengiriman berhasil
                                ...
                                if (response.respon_code == 1) {
                                    ...
                                    $("#pekerjaan_anak").val(data.JENIS_PKRJN);
                                    $("#pekerjaan_anak").attr("readonly", true);
