<div class="page-wrapper">
    ...
    <div class="container-fluid">
        ...
        <div class="modal fade myModal" id="tambahSuratKeluar"  role="dialog" aria-labelledby="tambahSuratKeluar">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <div class="custom-file">
                                        <input type="file" class="custom-file-input" id="inputGroupFile01" name="namafile_surat">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" value="" class="form-control namafile_surat" id="namafile_surat2" name="namafile_surat" readonly>
        ...
        $(document).on('click', '.lihat_data', function(e) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $('#namafile_surat2').val(data.namafile_surat);
                }
            });
        });
