<div class="page-wrapper">
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-12">
                <h4 class="page-title">D.IN.2 - Simbol Sektor</h4>
                <h5>Simbol Sektor Pada bidang Ideologi, Politik, Pertahanan dan Keamanan dan Cekal Pora</h5>
            </div>
        </div>
    </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="float-right">
                            ...
                            <a target="_blank" href="<?= base_url('din2/export') ?>" id="export" type="button" class="btn waves-effect waves-light btn-danger" style="width: 120px;">Export</a>
                        </div>
                    </div>
                </div>
            </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        $("#form-insert").on('submit', (function(event) {
            ...
            $.ajax({
                url: "<?= base_url('din2/prosesTambahData') ?>",
                type: "POST",
        ...
        $("#form-edit").on('submit', (function(event) {
            ...
            $.ajax({
                url: "<?= base_url('din2/prosesUpdateData') ?>",
                type: "POST",
                data: new FormData(this),
                dataType: "JSON",
                contentType: false,
    ...
    function hapus(id) {
        swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    type: "POST",
                    url: "<?= base_url('din2/prosesHapusData') ?>",
                    data: {
                        "id_data": id
                    },
                    dataType: "json",
