<div class="page-wrapper">
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-12">
                <h4 class="page-title">Data Pengundangan Peraturan <?= ce($this->userData->jenis_desa) ?></h4>
            </div>
                            ...
                            <table id="alt_pagination" class="table table-striped table-bordered display" style="width:100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="width: 30%; padding: 10px;" class="align-middle text-center" colspan="2">Pengundangan</th>
                                ...
                                <tbody>
                                    ...
                                    foreach ($sk_pengundangan_perdes as $data) : ?>
                                        <tr>
                                            ...
                                            <td style="padding: 5px;" class="align-middle text-center"><?= $data->no_pengundangan ?></td>
                                            <td style="padding: 5px;" class="align-middle text-center"><?= $data->tgl_pengundangan ?></td>
                                            <td style="padding: 5px;" class="align-middle text-center">
                                                <button title="Lihat Detail" class="btn btn-sm btn-info waves-effect waves-light" type="button" data-toggle="modal" data-target="#lihat_data<?= $data->id_sk_pengundangan_perdes ?>">
                                                    <span class="btn-label"><i class="fa fa-file-alt"></i></span>
                                                </button>
                                                <button title="Ubah Data" class="btn btn-sm btn-warning waves-effect waves-light" type="button" data-toggle="modal" data-target="#ubah_data<?= $data->id_sk_pengundangan_perdes ?>">
                                                    <span class="btn-label"><i class="fa fa-edit"></i></span>
                                                </button>
                                                <button title="Hapus Data" class="btn btn-sm btn-danger waves-effect waves-light delete_data" type="button" data-id="<?= $data->id_sk_pengundangan_perdes ?>">
                                                    <span class="btn-label"><i class="mdi mdi-delete-forever"></i></span>
                                                </button>
                                            </td>

                                            <!-- MODAL LIHAT DATA-->
                                            <div class="modal fade" id="lihat_data<?= $data->id_sk_pengundangan_perdes ?>" tabindex="-1" role="dialog" aria-labelledby="lihat_data">
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header bg-info">
                                                            <h4 class="modal-title text-white" id="exampleModalLabel1">Detail Pengundangan Peraturan <?= ce($this->userData->jenis_desa) ?></h4>
                                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                                        </div>
                                                        <div class="modal-body">
                                                            <div class="row">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        <label for="message-text" class="control-label">Nomor Pengundangan</label>
                                                                        <input type="text" class="form-control" name="no_pengundangan" id="nomor_pengundangan" value="<?= $data->no_pengundangan ?>" readonly>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        <label for="message-text" class="control-label">Tanggal Pengundangan</label>
                                                                        <div class="input-group" style="width: 100%;">
                                                                            <input type="text" class="form-control tgl_pengundangan" id="datepicker-autoclose2" name="tgl_pengundangan" placeholder="mm/dd/yyyy" value="<?= tanggal_tampil($data->tgl_pengundangan) ?>" readonly>
                                                                            <div class="input-group-append">
                                                                                <span class="input-group-text"><i class="far fa-calendar-alt"></i></span>
                                                                            </div>
                                                                        </div>
                                            ...
                                            <!-- END MODAL -->
                                            <!-- MODAL TAMBAH SURAT KELUAR -->
                                            <div class="modal fade modal_ubah" id="ubah_data<?= $data->id_sk_pengundangan_perdes; ?>" tabindex="-1" role="dialog" aria-labelledby="ubah_data">
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header bg-warning">
                                                            <h4 class="modal-title text-white" id="exampleModalLabel1">Ubah Pengundangan Peraturan <?= ce($this->userData->jenis_desa) ?></h4>
                                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                                        </div>
                                                        <div class="modal-body">
                                                            <form class="form-edit" enctype='multipart/form-data'>
                                                                <input type="hidden" name="id_sk_pengundangan_perdes" value="<?= $data->id_sk_pengundangan_perdes; ?>">
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            <label for="message-text" class="control-label">Nomor peraturan <?= ce($this->userData->jenis_desa) ?></label>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            <label for="message-text" class="control-label">Nomor Pengundangan</label>
                                                                            <input type="text" class="form-control" name="no_pengundangan" id="nomor_pengundangan" value="<?= $data->no_pengundangan ?>" required>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            <label for="message-text" class="control-label">Tanggal Pengundangan</label>
                                                                            <div class="input-group" style="width: 100%;">
                                                                                <input type="text" class="form-control tgl_pengundangan" id="datepicker-autoclose2" name="tgl_pengundangan" placeholder="mm/dd/yyyy" value="<?= tanggal_tampil($data->tgl_pengundangan) ?>" required>
                                                                                <div class="input-group-append">
                                                                                    <span class="input-group-text"><i class="far fa-calendar-alt"></i></span>
                                                                                </div>
                                                                            </div>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="input-group mb-3">
                                                                        <button type="button" class="btn btn-info"><i class="ti-import text-white"></i></button>
                                                                        <div class="custom-file">
                                                                            <input type="file" class="custom-file-input" id="inputGroupFile<?= $data->id_sk_pengundangan_perdes; ?>" name="file_lampiran">
                                                                            <label class="custom-file-label" for="inputGroupFile<?= $data->id_sk_pengundangan_perdes; ?>">Pilih File Dokumen</label>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                        </div>
...
<script>
    ...
    $("#btnCari").click(function() {
        window.location.replace("<?= base_url('dokumen/pengundangan_perdes/?tahun=') ?>" + $("#tahun").val());
    });
    ...
    $(document).ready(function() {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    $.ajax({
                        ...
                        url: "<?= base_url('dokumen/hapus_sk_pengundangan_perdes') ?>", // Isi dengan url/path file php yang dituju
                        data: {
                            "id_sk_pengundangan_perdes": id
                        ...
                        success: function(data) { // Ketika proses pengiriman berhasil
                            if (data.response_code == 200) {
                                Swal.fire(
                                    ...
                                    window.location.href = "<?= base_url('dokumen/pengundangan_perdes') ?>";
                                })
        ...
        $(".form-edit").on('submit', (function(event) {
            ...
            $.ajax({
                url: "<?= base_url('dokumen/ubah_sk_pengundangan_perdes') ?>",
                type: "POST",
        ...
        $("#form-insert").on('submit', (function(event) {
            ...
            $.ajax({
                url: "<?= base_url('dokumen/tambah_sk_pengundangan_perdes') ?>",
                type: "POST",
                data: new FormData(this),
                dataType: "JSON",
                contentType: false,
