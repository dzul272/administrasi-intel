<div class="page-wrapper">
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-12">
                <h4 class="page-title">Data Pengundangan Peraturan Kepala <?= ce($this->userData->jenis_desa) ?></h4>
            </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="float-right">
                            ...
                            ?>
                            <a href="<?= base_url('dokumen/export-sk-pengundangan-perkades/?tahun=' . $thn) ?>" id="export" type="button" class="btn waves-effect waves-light btn-danger" style="width: 120px;">Export</a>
                        </div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title" id="exampleModalLabel1">Tambah Pengundangan Peraturan Kepala <?= ce($this->userData->jenis_desa) ?></h4>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                    </div>
                    <div class="modal-body">
                        <!-- <form action="<?= base_url('dokumen/tambah_sk_pengundangan_perkades') ?>" method="post" enctype='multipart/form-data'> -->
                                    ...
                                    foreach ($sk_pengundangan_perkades as $data) : ?>
                                        <tr>
                                            ...
                                            <td style="padding: 5px;" class="align-middle text-center">
                                                <button title="Lihat Detail" class="btn btn-sm btn-info waves-effect waves-light" type="button" data-toggle="modal" data-target="#lihat_data<?= $data->id_sk_pengundangan_perkades ?>">
                                                    <span class="btn-label"><i class="fa fa-file-alt"></i></span>
                                                </button>
                                                <button title="Ubah Data" class="btn btn-sm btn-warning waves-effect waves-light" type="button" data-toggle="modal" data-target="#ubah_data<?= $data->id_sk_pengundangan_perkades ?>">
                                                    <span class="btn-label"><i class="fa fa-edit"></i></span>
                                                </button>
                                                <button title="Hapus Data" class="btn btn-sm btn-danger waves-effect waves-light delete_data" type="button" data-id="<?= $data->id_sk_pengundangan_perkades ?>">
                                                    <span class="btn-label"><i class="mdi mdi-delete-forever"></i></span>
                                                </button>
                                            </td>

                                            <!-- MODAL LIHAT DATA-->
                                            <div class="modal fade" id="lihat_data<?= $data->id_sk_pengundangan_perkades ?>" tabindex="-1" role="dialog" aria-labelledby="lihat_data">
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header bg-info">
                                                            <h4 class="modal-title text-white" id="exampleModalLabel1">Detail Pengundangan Peraturan Kepala <?= ce($this->userData->jenis_desa) ?></h4>
                                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                                        </div>
                                                        <div class="modal-body">
                                                            <div class="row">
                                            ...
                                            <!-- END MODAL -->
                                            <!-- MODAL TAMBAH SURAT KELUAR -->
                                            <div class="modal fade modal_ubah" id="ubah_data<?= $data->id_sk_pengundangan_perkades; ?>" tabindex="-1" role="dialog" aria-labelledby="ubah_data">
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header bg-warning">
                                                            <h4 class="modal-title text-white" id="exampleModalLabel1">Ubah Pengundangan Peraturan Kepala <?= ce($this->userData->jenis_desa) ?></h4>
                                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                                        </div>
                                                        <div class="modal-body">
                                                            ...
                                                            <form class="form-edit" enctype='multipart/form-data'>
                                                                <input type="hidden" name="id_sk_pengundangan_perkades" value="<?= $data->id_sk_pengundangan_perkades; ?>">
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            <label for="message-text" class="control-label">Nomor Peraturan Kepala <?= ce($this->userData->jenis_desa) ?></label>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="input-group mb-3">
                                                                        <button type="button" class="btn btn-info"><i class="ti-import text-white"></i></button>
                                                                        <div class="custom-file">
                                                                            <input type="file" class="custom-file-input" id="inputGroupFile<?= $data->id_sk_pengundangan_perkades; ?>" name="file_lampiran">
                                                                            <label class="custom-file-label" for="inputGroupFile<?= $data->id_sk_pengundangan_perkades; ?>">Pilih File Dokumen</label>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                        </div>
                                            ...
                                            <div class="modal fade" id="hapus_data" tabindex="-1" role="dialog" aria-labelledby="hapus_data">
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h4 class="modal-title" id="exampleModalLabel1">Hapus Peraturan Kepala <?= ce($this->userData->jenis_desa) ?></h4>
                                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                                        </div>
                                                        <div class="modal-body">
                                                            <form>
...
<script>
    ...
    $("#btnCari").click(function() {
        window.location.replace("<?= base_url('dokumen/pengundangan_perkades/?tahun=') ?>" + $("#tahun").val());
    });
    ...
    $(document).ready(function() {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    $.ajax({
                        ...
                        url: "<?= base_url('dokumen/hapus_sk_pengundangan_perkades') ?>", // Isi dengan url/path file php yang dituju
                        data: {
                            "id_sk_pengundangan_perkades": id
                        ...
                        success: function(data) { // Ketika proses pengiriman berhasil
                            if (data.response_code == 200) {
                                Swal.fire(
                                    ...
                                    window.location.href = "<?= base_url('dokumen/pengundangan_perkades') ?>";
                                })
        ...
        $(".form-edit").on('submit', (function(event) {
            ...
            $.ajax({
                url: "<?= base_url('dokumen/ubah_sk_pengundangan_perkades') ?>",
                type: "POST",
        ...
        $("#form-insert").on('submit', (function(event) {
            ...
            $.ajax({
                url: "<?= base_url('dokumen/tambah_sk_pengundangan_perkades') ?>",
                type: "POST",
                data: new FormData(this),
                dataType: "JSON",
                contentType: false,
