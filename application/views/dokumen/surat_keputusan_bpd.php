<div class="page-wrapper">
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-12">
                <h4 class="page-title">Agenda Surat Keputusan BPD</h4>
            </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="float-right">
                            ...
                            <a href="<?= base_url('dokumen/export-sk-bpd/?tahun=' . $thn) ?>" id="export" type="button" class="btn waves-effect waves-light btn-danger" style="width: 120px;">Export</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title" id="exampleModalLabel1">Tambah Surat Keputusan BPD</h4>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                    </div>
                    <div class="modal-body">
                        <!-- <form action="<?= base_url('dokumen/tambah_sk_bpd') ?>" method="post" enctype='multipart/form-data'> -->
                        <form id="form-insert" enctype='multipart/form-data'>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="message-text" class="control-label">Nomor Keputusan BPD</label>
                                        <input type="text" class="form-control" name="nomor" id="nomor_keputusan_bpd" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="message-text" class="control-label">Tanggal Keputusan BPD</label>
                                        <div class="input-group" style="width: 100%;">
                                            <input type="text" class="form-control tgl_keputusan_bpd" id="datepicker-autoclose5" name="tanggal" placeholder="mm/dd/yyyy" required>
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="alt_pagination" class="table table-striped table-bordered display" style="width:100%">
                                <thead>
                                    <tr>
                                        <th style="width: 5%; padding: 10px;" class="align-middle text-center" rowspan="2">No</th>
                                        <th style="width: 35%; padding: 10px;" class="align-middle text-center" colspan="2">Surat keputusan BPD</th>
                                        <th style="width: 20%; padding: 10px;" class="align-middle text-center" rowspan="2">Tentang</th>
                                        <th style="width: 20%; padding: 10px;" class="align-middle text-center" rowspan="2">Uraian singkat</th>
                                        <th style="width: 14%; padding: 10px;" class="align-middle text-center" rowspan="2">Aksi</th>
                                    </tr>
                                    <tr>
                                        <th style="width: 18%; padding: 10px;" class="align-middle text-center">Nomor</th>
                                        <th style="width: 18%; padding: 10px;" class="align-middle text-center">Tanggal</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php
                                    ...
                                    foreach ($sk_bpd as $data) : ?>
                                        <tr>
                                            ...
                                            <td style="padding: 5px;" class="align-middle text-center"><?= $data->nomor; ?></td>
                                            <td style="padding: 5px;" class="align-middle text-center"><?= $data->tanggal; ?></td>
                                            <td style="padding: 5px;" class="align-middle"><?= sc($data->tentang); ?></td>
                                            <td style="padding: 5px;" class="align-middle"><?= $data->uraian; ?></td>
                                            <td style="padding: 5px;" class="align-middle text-center">
                                                <button title="Lihat Detail" class="btn btn-sm btn-info waves-effect waves-light" type="button" data-toggle="modal" data-target="#lihat_data<?= $data->id_sk_bpd; ?>">
                                                    <span class="btn-label"><i class="fa fa-file-alt"></i></span>
                                                </button>
                                                <button title="Ubah Data" class="btn btn-sm btn-warning waves-effect waves-light" type="button" data-toggle="modal" data-target="#ubah_data<?= $data->id_sk_bpd; ?>">
                                                    <span class="btn-label"><i class="fa fa-edit"></i></span>
                                                </button>
                                                <!-- <button title="Hapus Data" class="btn btn-sm btn-danger waves-effect waves-light" type="button" data-toggle="modal" data-target="#hapus_data<?= $data->id_sk_bpd; ?>"> -->
                                                <button title="Hapus Data" class="btn btn-sm btn-danger waves-effect waves-light delete_sk_bpd" type="button" data-id="<?= $data->id_sk_bpd; ?>">
                                                    <span class="btn-label"><i class="mdi mdi-delete-forever"></i></span>
                                                </button>
                                            </td>

                                            <!-- MODAL LIHAT DATA-->
                                            <div class="modal fade" id="lihat_data<?= $data->id_sk_bpd; ?>" tabindex="-1" role="dialog" aria-labelledby="ubah_data">
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header bg-info">
                                                            <h4 class="modal-title text-white" id="exampleModalLabel1">Detail Surat Keputusan BPD</h4>
                                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                                        </div>
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        <label for="message-text" class="control-label">Nomor Keputusan BPD</label>
                                                                        <input type="text" class="form-control" name="nomor" id="nomor_keputusan_bpd" value="<?= $data->nomor; ?>" readonly>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        <label for="message-text" class="control-label">Tanggal Keputusan BPD</label>
                                                                        <div class="input-group" style="width: 100%;">
                                                                            <input type="text" class="form-control tgl_keputusan_bpd" id="datepicker-autoclose5" name="tanggal" placeholder="mm/dd/yyyy" value="<?= tanggal_tampil($data->tanggal); ?>" readonly>
                                                                            <div class="input-group-append">
                                                                                <span class="input-group-text"><i class="far fa-calendar-alt"></i></span>
                                                                            </div>
                                                                        </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="input-group mb-3">
                                                                    ...
                                                                    <input type="text" value="<?= $data->file_lampiran == NULL ? 'Tidak Ada File Lampiran' : $data->file_lampiran ?>" class="form-control" id="lampiran" name="file_lampiran" readonly>
                                            ...
                                            <!-- MODAL TAMBAH SURAT KELUAR -->
                                            <div class="modal fade modal_ubah" id="ubah_data<?= $data->id_sk_bpd; ?>" tabindex="-1" role="dialog" aria-labelledby="ubah_data">
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header bg-warning">
                                                            <h4 class="modal-title text-white" id="exampleModalLabel1">Ubah Surat Keputusan BPD</h4>
                                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                                        </div>
                                                        <div class="modal-body">
                                                            <!-- <form action="<?= base_url('dokumen/ubah_sk_bpd') ?>" method="post" enctype='multipart/form-data'> -->
                                                            <form class="form-edit" enctype='multipart/form-data'>
                                                                <input type="hidden" class="form-control" name="id_sk_bpd" value="<?= $data->id_sk_bpd; ?>">
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            <label for="message-text" class="control-label">Nomor Keputusan BPD</label>
                                                                            <input type="text" class="form-control" name="nomor" id="nomor_keputusan_bpd" value="<?= $data->nomor; ?>" required>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            <label for="message-text" class="control-label">Tanggal Keputusan BPD</label>
                                                                            <div class="input-group" style="width: 100%;">
                                                                                <input type="text" class="form-control tgl_keputusan_bpd" id="datepicker-autoclose5" name="tanggal" placeholder="mm/dd/yyyy" value="<?= tanggal_tampil($data->tanggal); ?>" required>
                                                                                <div class="input-group-append">
                                                                                    <span class="input-group-text"><i class="far fa-calendar-alt"></i></span>
                                                                                </div>
                                                                            </div>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="input-group mb-3">
                                                                        <button type="button" class="btn btn-info"><i class="ti-import text-white"></i></button>
                                                                        <div class="custom-file">
                                                                            <input type="file" class="custom-file-input" id="inputGroupFile<?= $data->id_sk_bpd; ?>" name="file_lampiran">
                                                                            <label class="custom-file-label" for="inputGroupFile<?= $data->id_sk_bpd; ?>">Pilih File Dokumen</label>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                        </div>
                                            ...
                                            <div class="modal fade modal_ubah" id="hapus_data<?= $data->id_sk_bpd; ?>" tabindex="-1" role="dialog" aria-labelledby="hapus_data">
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
...
<script>
    $("#btnCari").click(function() {
        window.location.replace("<?= base_url('dokumen/surat-keputusan-bpd/?tahun=') ?>" + $("#tahun").val());
    });
    let base_url = "<?= base_url('dokumen/downloadFile'); ?>";

    $(document).ready(function() {
        //AJAX HAPUS DATA
        $(document).on('click', '.delete_sk_bpd', function(e) {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    $.ajax({
                        ...
                        url: "<?= base_url('dokumen/hapus_sk_bpd') ?>", // Isi dengan url/path file php yang dituju
                        data: {
                            "id_sk_bpd": id
                        ...
                        success: function(data) { // Ketika proses pengiriman berhasil
                            if (data.response_code == 200) {
                                Swal.fire(
                                    ...
                                    window.location.href = "<?= base_url('dokumen/surat-keputusan-bpd') ?>";
                                })
        ...
        $(".form-edit").on('submit', (function(event) {
            ...
            $.ajax({
                url: "<?= base_url('dokumen/ubah_sk_bpd') ?>",
                type: "POST",
        ...
        $("#form-insert").on('submit', (function(event) {
            ...
            $.ajax({
                url: "<?= base_url('dokumen/tambah_sk_bpd') ?>",
                type: "POST",
                data: new FormData(this),
                dataType: "JSON",
                contentType: false,
